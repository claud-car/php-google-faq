...
<body>
    <?php 
        $faqs = [
            $one = [
                "question" => "<div class='faq'><h3>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h3>",
                "answer" => 
            ...
            $two = [
                "question" => "<div class='faq'><h3>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h3>",
                "answer" => "
            ...
            $three = [
                "question" => "<div class='faq'><h3>Perché il mio account è associato a un paese?</h3>",
                "answer" => "
            ...
            $four = [
                "question" => "<div class='faq'><h4>Stabilire il paese associato al tuo account</h4>",
                "answer" => "
            ...
            $five = [
                "question" => "<div class='faq'><h3>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?</h3>",
                "answer" => "
            ...
            $six = [
                "question" => "<div class='faq'><h3>Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?</h3>",
                "answer" => "
